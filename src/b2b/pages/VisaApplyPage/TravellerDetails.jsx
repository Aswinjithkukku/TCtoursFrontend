...
import { addRows, handleRowItemChange, handleDOBChange } from '../../../redux/slices/visaSlice'
...
function TravellerDetails() {
  ...
  const { rows, visaEnquiry, visa } = useSelector(state => state.visa)
    ...
    <div className='p-6 text-darktext '>
      ...
      <div className='bg-white p-6 rounded-md shadow'>
                ...
                <div className=''>
                  ...
                  >
                    ...
                    {countries?.map((item, index) => (
                      <option key={index} value={item?._id} className='capitalize' >{item?.countryName} </option>
                    ))}
                  </select>
                </div>
              </div>
                ...
                <div className='w-full'>
                  ...
                  >
                    ...
                    {MonthNames.map((item, index) => (
                      <option key={index} value={item.value} className='capitalize'>{item.name} </option>
                    ))}
                  </select>
                </div>
              </div>
        ...
        <div className='flex justify-end'>
          <button type='submit' className='bg-lightblue text-[14px] text-white px-3 py-2 rounded'>
            Move to Payment
          </button>
        </div>
      </div>

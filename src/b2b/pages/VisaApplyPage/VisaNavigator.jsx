...
function VisaNavigator() {
   ...
   return (
      <>
            ...
            <div className=" text-darktext ">
               <div className=" overflow-x-auto scrollbar-hide">
                  <div className=" w-full flex justify-between items-center ">
                     ...
                     <button
                        className={`col-span-2 w-full flex w-full justify-center text-[10px] lg:text-sm md:text-base items-center px-5 md:px-3 py-3  hover:text-lightblue  ${
                           navigation.details ||
                           navigation.upload ||
                           navigation.payment
                              ? "border-b-4 text-lightblue"
         ...
         <div className="main w-full flex gap-2">
            ...
            <div className="md:w-[20%] hidden md:block py-8 lg:pr-6">

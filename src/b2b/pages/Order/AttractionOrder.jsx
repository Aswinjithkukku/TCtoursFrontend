   ...
   const fetchOrders = async ({ ...filters }) => {
      try {
         ...
         response = await axios.get(
            `/b2b/attractions/orders/all?${searchQuery}`,
            {
      ...
      <div>
         ...
         <div className="p-2 lg:px-6">
            <div className="">
               ...
               <div className="hidden lg:block overflow-x-auto order__scroll ">
                  <InfiniteScroll
                        ...
                        <tbody className="text-sm overflow-hidden text-textColor">
                           {orders?.length > 0 ? (
                              orders?.map((item, index) => (
                                 <AttractionOrderTable
                                    item={item}
                                    key={index}
                                 />
                                 // <AttractionOrdersChipList item={item} key={index} />
                              ))
                           ) : (
                              <>
                                 <tr>
               ...
               <div className="lg:hidden overflow-x-auto order__scroll ">
                  <InfiniteScroll
                     dataLength={orders?.length || 0}
                     next={() => {
                        setFilters((prev) => {

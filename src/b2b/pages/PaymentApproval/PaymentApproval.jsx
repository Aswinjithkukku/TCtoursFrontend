...
function PaymentApproval() {
  ...
  return (
    <div className='lg:max-w-screen-xl lg:mx-auto'>
      <div className='bg-light shadow-sm md:rounded-md overflow-hidden w-full md:my-6'>
        <div className='lg:grid grid-cols-12 gap-5'>
          ...
          <div className='2 col-span-9 p-6'>
            <div className='md:flex justify-around items-center border-b border-dashed mb-5'>
              <div className=''>

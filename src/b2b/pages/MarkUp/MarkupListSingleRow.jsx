...
function MarkupListSingleRow({ item }) {
  ...
  const { loading } = useSelector((state) => state.markups);
          ...
          <span className="flex space-x-2">
            <p className="">
              {markupData?.agent && markupData?.agent !== {}
                ? (markupData?.agent?.markupType === "flat" &&
                    priceConversion(
                      markupData?.agent?.markup,
                      selectedCurrency,
                      true
                    )) ||
                  (markupData?.agent?.markupType === "percentage" &&
                    `${markupData?.agent?.markup} %`)
                : "N/A"}
            </p>
            {/* <p className=''></p> */}
            ...
            <p className="">
              {markupData?.client && markupData?.client !== {}
                ? (markupData?.client?.markupType === "flat" &&
                  ...
                  (markupData?.client?.markupType === "percentage" &&
                    `${markupData?.client?.markup} %`)
                : "N/A"}
            </p>
            {/* <p className=''></p> */}

              ...
              <div className="p-5 space-y-3 ">
                <div className="flex border-b pb-2">
                  <span className="text-xl text-lightblue font-[600]  underline">
                    {priceConversion(item?.totalPrice, selectedCurrency, true)}{" "}
                  </span>
                </div>
                ...
                <div className="">
                    <div className="flex justify-between">
                        ...
                        <p className="text-[13px] font-[550] text-text capitalize">{item?.entryType} </p>
                    </div>
                    <div className="flex justify-between">
                        <p className="text-[13px] font-[550] text-text">Service Charge</p>
                        <p className="text-[13px] font-[550] text-text">{item?.serviceCharge} </p>
                    </div>
                    <div className="flex justify-between">
                        <p className="text-[13px] font-[550] text-text">Tax</p>
                        <p className="text-[13px] font-[550] text-text">{item?.tax} </p>
                    </div>
                </div>

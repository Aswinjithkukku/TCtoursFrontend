        ...
        <div className=" relative">
          <div className="  md:w-4/12  rounded-t-md md:rounded-t-md overflow-x-auto  scrollbar-hide">
            <div className=" flex md:grid md:grid-cols-2 space-x-1 px-1 py-3 md:py-1 items-center ">
              {/* <button className={`flex justify-center text-sm md:text-base items-center px-2 md:px-3 py-2 rounded-t-md  hover:text-light hover:bg-blueColor duration-300 space-x-1 ${view.attraction ? "bg-lightblue text-light" : "text-blue bg-trans"}`} onClick={() => {
                setView((prev) => {
              ...
              {/* <button className={`flex justify-center text-sm md:text-base items-center px-5 md:px-3 py-2 rounded-t-md  hover:text-light hover:bg-blueColor duration-300 space-x-1  ${view.flight ? "bg-lightblue text-light" : "text-blue bg-trans"}`} onClick={() => {
                setView((prev) => {
              ...
              <button className={`flex justify-center text-sm md:text-base items-center px-5 md:px-3 py-2 rounded-t-md  hover:text-light hover:bg-blueColor duration-300 space-x-1  ${view.hotel ? "bg-lightblue text-light" : "text-blue bg-trans"}`} onClick={() => {
                setView((prev) => {
              ...
              {/* <button className={`flex justify-center text-sm md:text-base items-center px-6 md:px-3 py-2 rounded-t-md  hover:text-light hover:bg-blueColor duration-300 space-x-1  ${view.visa ? "bg-lightblue text-light" : "text-blue bg-trans"}`} onClick={() => {
                setView((prev) => {
              ...
              {/* <button className={`flex justify-center text-sm md:text-base items-center px-6 md:px-3 py-2 rounded-t-md  hover:text-light hover:bg-blueColor duration-300 space-x-1  ${view.transfer ? "bg-lightblue text-light" : "text-blue bg-trans"}`} onClick={() => {
                setView((prev) => {

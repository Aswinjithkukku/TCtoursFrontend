...
function SearchingResultPage() {
  ...
  useEffect(() => {
    if (params.slug === "isOffer") {
      isOffer = "true";
      dispatch(
        getAllExcursions({ isOffer, category, search, rating, duration })
      );
    } else if (params.slug === "isCombo") {
      isCombo = "true";
      dispatch(
        getAllExcursions({ isCombo, category, search, rating, duration })
      );
    } else {
      destination = params.slug;
      dispatch(
        getAllExcursions({ destination, category, search, rating, duration })
      );
    }

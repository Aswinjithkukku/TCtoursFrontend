...
import { setExcursion } from "../../redux/slices/excursionSlice";
import HeroSection from "../AttractionDetails/HeroSection";
import ImageSection from "../AttractionDetails/ImageSection";
...
function AttractionDetailsPage() {
  ...
  const fetchData = async (id) => {
    try {
      ...
      dispatch(setExcursion(response.data));
      setIsLoading(false);
    } catch (err) {
  ...
  return (
    <>
      {isLoading ? (
        <div className="lg:mx-auto lg:max-w-screen-2xl my-10 rounded animate-pulse ">

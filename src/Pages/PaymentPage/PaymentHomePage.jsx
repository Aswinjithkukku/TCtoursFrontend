    ...
    return (
        <div className='lg:max-w-screen-xl lg:mx-auto'>
            <div className='lg:flex lg:justify-between text-darktext p-5 bg-light rounded-2xl cursor-default space-y-3'>
                <div className='lg:space-y-5 font-light lg:text-lg'>
                ...
                <div className='lg:space-y-5 space-y-2 font-medium'>
                    <div className='font-light lg:text-lg'>Currently, you have {excursionCart && excursionCart?.length}  item(s) in your cart</div>
                    <div className=''>

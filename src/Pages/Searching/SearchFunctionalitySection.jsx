...
function SearchFunctionalitySection({ viewCategory, setViewCategory, setRating, setDuration }) {
    ...
    return (
        <>
            ...
            <div className={`bg-soft  p-5 lg:p-0 rounded-t-3xl overflow-y-auto lg:rounded-none lg:bg-soft lg:h-auto lg:w-auto h-[85vh] w-full fixed lg:static ${viewCategory ? "bottom-0" : "-bottom-full"} z-10 transition-all duration-500`}>

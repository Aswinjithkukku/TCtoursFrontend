      ...
      <>
         <div className="bg-light  lg:rounded-xl p-5 space-y-2 mb-2">
            ...
            <div className="flex justify-between items-center">
               ...
               {/* offer percentage  */}
               <span>
                  <p className="text-[9px] text-text">cheapest price*</p>
                  {excursion?.isOffer && (
                     <span className="bg-green-500 text-white px-1 py-1 text-[10px] rounded text-blue">
                        {priceConversion(
               ...
               <div className="hidden lg:block py-7 space-y-3">
                  <div className="">
                     <p className="text-text">
                        if you have questions about this tour, please feel free
                        to ask
                     </p>
                  </div>
                  <div className="">
